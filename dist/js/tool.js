...
Nova.booting(function (Vue, router, store) {
    router.addRoutes([{
        ...
        component: __WEBPACK_IMPORTED_MODULE_0__components_Tool___default.a
    }]);
});
                    ...
                    [
                      _c(
                        ...
                        _vm._l(section.resources, function(resource) {
                          return _c(
                            "li",
                            { staticClass: "text-sm leading-normal pb-1" },
                            [
                              _c(
                                "router-link",
                                {
                                  staticClass: "no-underline text-primary dim",
                                  attrs: {
                                    to: {
                                      name: "index",
                                      params: { resourceName: resource.uriKey }
                                    }
                                  }
                                },
